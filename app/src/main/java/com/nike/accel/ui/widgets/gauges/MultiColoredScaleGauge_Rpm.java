 ...
 */
public class MultiColoredScaleGauge_Rpm extends LinearLayout implements IGaugeUI {
  ...
  //  private ImageView mImageViewConnection;
    ...
    public MultiColoredScaleGauge_Rpm(Context context) {
        super(context);
        this.mContext = context;
    }

    public MultiColoredScaleGauge_Rpm(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }
    ...
    private void initialize(Context context) {
        ...
        final View vRoot = inflater.inflate(R.layout.gauge_multi_colored_scale_rpm, null, false);
