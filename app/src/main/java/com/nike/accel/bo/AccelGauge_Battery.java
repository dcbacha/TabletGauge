 ...
 */
public class AccelGauge_Battery implements IGauge, SensorEventListener {
     ...
     * @param context
     */
    public AccelGauge_Battery(IGaugeUI iGaugeUI, IGaugeData iGaugeData, Context context) {
        mIGaugeUI = iGaugeUI;
